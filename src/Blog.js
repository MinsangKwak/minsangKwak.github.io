...
const Blog = ({ posts = [] }) => {
	...
	return (
		<div className="flex flex-col min-h-screen bg-gray-100">
			...
			<aside
				className={`fixed top-0 right-0 h-full w-64 bg-black text-white transform transition-transform duration-300 z-20 ${
			...
			<div className="flex-1 mt-16 p-6">
				{selectedPost ? (
					<div className="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow-md">
						<h2 className="text-4xl font-bold text-gray-900 mb-2">{selectedPost.title}</h2>
						<h3 className="text-2xl text-gray-600 mb-4">{selectedPost.subtitle}</h3>
						<p className="text-gray-700 leading-relaxed mb-8">{selectedPost.content}</p>

						{/* Additional Sections for a Learning Path Style */}
						<h3 className="text-2xl font-bold text-gray-900 mt-8 mb-4">더 알아보기</h3>
						...
						<h3 className="text-2xl font-bold text-gray-900 mt-8 mb-4">관련 학습 항목</h3>
